...
date_list=$(date +"%Y-%m-%d" -d "$data_server")
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e " WELCOME TO FANVPN  STORE ${YELLOW}(${NC}${green}Stable Edition${NC}${YELLOW})${NC}"
echo -e " PROSES PENGECEKAN IP ADDRESS ANDA !!"
echo -e "${purple}----------------------------------------------------------${NC}"
echo -e " ›AUTHOR : ${green}MERAUKE•VPM® ${NC}${YELLOW}(${NC}${green}V [Freedom Internet]${NC}${YELLOW})${NC}"
echo -e " ›TEAM 🅥🅝: NZNXAJI🇲🇨 ${YELLOW}(${NC} 2024 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
...
# Ganti Banner
wget -O /etc/hokage.txt https://raw.githubusercontent.com/Pemulaajiw/script-free/main/issue.net
...
function menu(){
    ...
    wget https://raw.githubusercontent.com/Pemulaajiw/script-free/main/menu.zip
    unzip menu.zip
    chmod +x menu/*
